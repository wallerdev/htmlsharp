...
{
    public class Em : Tag, IAllowsNesting
    {
        ...
        public Em(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Em(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Em(IEnumerable<TagAttribute> attributes, params Element[] children)
