...
{
    public class Small : Tag, IAllowsNesting
    {
        ...
        public Small(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Small(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Small(IEnumerable<TagAttribute> attributes, params Element[] children)
