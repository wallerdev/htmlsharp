...
{
    public class Sub : Tag, IAllowsNesting
    {
        ...
        public Sub(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Sub(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Sub(IEnumerable<TagAttribute> attributes, params Element[] children)
