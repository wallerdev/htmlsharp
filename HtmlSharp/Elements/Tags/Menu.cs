...
{
    public class Menu : Tag, IAllowsNesting
    {
        ...
        public Menu(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Menu(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Menu(IEnumerable<TagAttribute> attributes, params Element[] children)
