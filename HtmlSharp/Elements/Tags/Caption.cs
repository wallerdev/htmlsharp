...
{
    public class Caption : Tag, IAllowsNesting
    {
        ...
        public Caption(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Caption(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Caption(IEnumerable<TagAttribute> attributes, params Element[] children)
