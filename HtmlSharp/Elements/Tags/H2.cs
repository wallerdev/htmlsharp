...
{
    public class H2 : Tag, IAllowsNesting
    {
        ...
        public H2(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public H2(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public H2(IEnumerable<TagAttribute> attributes, params Element[] children)
