...
{
    public class Pre : Tag, IAllowsNesting
    {
        ...
        public Pre(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Pre(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Pre(IEnumerable<TagAttribute> attributes, params Element[] children)
