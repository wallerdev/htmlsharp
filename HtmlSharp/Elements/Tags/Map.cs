...
{
    public class Map : Tag, IAllowsNesting
    {
        ...
        public Map(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Map(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Map(IEnumerable<TagAttribute> attributes, params Element[] children)
