...
{
    public class Big : Tag, IAllowsNesting
    {
        ...
        public Big(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Big(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Big(IEnumerable<TagAttribute> attributes, params Element[] children)
