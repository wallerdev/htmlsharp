...
{
    public class Var : Tag, IAllowsNesting
    {
        ...
        public Var(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public Var(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public Var(IEnumerable<TagAttribute> attributes, params Element[] children)
