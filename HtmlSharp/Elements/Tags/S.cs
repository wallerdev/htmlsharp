...
{
    public class S : Tag, IAllowsNesting
    {
        ...
        public S(params Element[] children)
            : this(new TagAttribute[0], children)
        {
        }

        public S(params TagAttribute[] attributes)
            : this(attributes, new Element[0])
        {
        }

        public S(IEnumerable<TagAttribute> attributes, params Element[] children)
